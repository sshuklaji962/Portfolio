    ...
    >
      ...
      >
        {state.language === "english"
          ? "मेरे साथ काम करने में दिलचस्पी है?"
      ...
      <div className="resume-box">
        ...
        <div className="resume-box-right">
          <p>
            {state.language === "english"
              ? "यदि आपके पास अभी भी कोई प्रश्न है, तो बेझिझक मुझसे संपर्क करें। इसके अतिरिक्त, आप नीचे मेरा बायोडाटा डाउनलोड कर सकते हैं।"
              : "Should you still have any questions, feel free to contact me. Additionally, you can download my resume below."}
          </p>
          <a
            download="cv_satyam.pdf"
          ...
          >
            ...
            {state.language === "english" ? "मुझसे संपर्क करें" : "Contact me"}
          </button>
        </div>
      </div>
    </div>
